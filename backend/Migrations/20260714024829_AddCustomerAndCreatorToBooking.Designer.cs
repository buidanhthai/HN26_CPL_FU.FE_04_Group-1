...
namespace backend.Migrations
{
    ...
    [Migration("20260714024829_AddCustomerAndCreatorToBooking")]
    partial class AddCustomerAndCreatorToBooking
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Entities.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 14, 2, 48, 28, 391, DateTimeKind.Utc).AddTicks(753),
                            EndTime = new DateTime(2026, 7, 15, 4, 48, 28, 391, DateTimeKind.Utc).AddTicks(119),
                            LayoutId = 1,
                            PaymentDeadline = new DateTime(2026, 7, 14, 2, 58, 28, 391, DateTimeKind.Utc).AddTicks(574),
                            SnapshotBasePrice = 50000m,
                            SnapshotPriceModifier = 0m,
                            StartTime = new DateTime(2026, 7, 15, 2, 48, 28, 390, DateTimeKind.Utc).AddTicks(9938),
                            UserId = 3
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 14, 2, 48, 28, 391, DateTimeKind.Utc).AddTicks(865),
                            EndTime = new DateTime(2026, 7, 16, 6, 48, 28, 391, DateTimeKind.Utc).AddTicks(864),
                            LayoutId = 1,
                            SnapshotBasePrice = 1200000m,
                            SnapshotPriceModifier = 50000m,
                            StartTime = new DateTime(2026, 7, 16, 2, 48, 28, 391, DateTimeKind.Utc).AddTicks(862),
                            UserId = 4
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 14, 2, 48, 28, 391, DateTimeKind.Utc).AddTicks(870),
                            EndTime = new DateTime(2026, 7, 14, 4, 48, 28, 391, DateTimeKind.Utc).AddTicks(869),
                            LayoutId = 2,
                            SnapshotBasePrice = 900000m,
                            SnapshotPriceModifier = 0m,
                            StartTime = new DateTime(2026, 7, 14, 1, 48, 28, 391, DateTimeKind.Utc).AddTicks(868),
                            UserId = 3
                        });
                });
            ...
            modelBuilder.Entity("backend.Entities.InternalTask", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookingId = 2,
                            CreatedAt = new DateTime(2026, 7, 14, 2, 48, 28, 391, DateTimeKind.Utc).AddTicks(1986),
                        ...
                        new
                        {
                            Id = 2,
                            BookingId = 3,
                            CreatedAt = new DateTime(2026, 7, 14, 2, 48, 28, 391, DateTimeKind.Utc).AddTicks(2116),
                            RequiredStaffCount = 1,
            ...
            modelBuilder.Entity("backend.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$UUrUTALbKFqEmq9KwWD0x.zoT7bsGD05PntrS50TeLw3GecHgN4Jy",
                            Role = "ADMIN"
                        },
                        new
                        {
