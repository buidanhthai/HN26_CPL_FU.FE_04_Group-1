...
namespace backend.Migrations
{
    ...
    [Migration("20260714091748_AddMoreServices")]
            ...
            modelBuilder.Entity("backend.Entities.AddOnService", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ChargeMethod = "Fixed",
                            IsAvailable = true,
                            ServiceName = "Bánh mì sừng bò (Croissant)",
                            UnitPrice = 30000m
                        },
                        new
                        {
                            Id = 7,
                            ChargeMethod = "By_Quantity",
                            IsAvailable = true,
                            ServiceName = "In ấn / Sao chụp tài liệu",
                            UnitPrice = 2000m
                        },
                        new
                        {
                            ...
                            ChargeMethod = "Fixed",
                            IsAvailable = true,
                            ServiceName = "Bảng di động & Bút viết",
                            UnitPrice = 30000m
                        });
                });
            ...
            modelBuilder.Entity("backend.Entities.Booking", b =>
                {
                    ...
                    b.Property<string>("CheckInVerificationCode")
                        .HasMaxLength(10)
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 14, 9, 17, 47, 380, DateTimeKind.Utc).AddTicks(9008),
                            EndTime = new DateTime(2026, 7, 15, 11, 17, 47, 380, DateTimeKind.Utc).AddTicks(7753),
                            LayoutId = 1,
                            PaymentDeadline = new DateTime(2026, 7, 14, 9, 27, 47, 380, DateTimeKind.Utc).AddTicks(8662),
                            SnapshotBasePrice = 50000m,
                            SnapshotPriceModifier = 0m,
                            StartTime = new DateTime(2026, 7, 15, 9, 17, 47, 380, DateTimeKind.Utc).AddTicks(7332),
                            UserId = 3
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 14, 9, 17, 47, 380, DateTimeKind.Utc).AddTicks(9265),
                            EndTime = new DateTime(2026, 7, 16, 13, 17, 47, 380, DateTimeKind.Utc).AddTicks(9263),
                            LayoutId = 1,
                            SnapshotBasePrice = 1200000m,
                            SnapshotPriceModifier = 50000m,
                            StartTime = new DateTime(2026, 7, 16, 9, 17, 47, 380, DateTimeKind.Utc).AddTicks(9262),
                            UserId = 4
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 14, 9, 17, 47, 380, DateTimeKind.Utc).AddTicks(9270),
                            EndTime = new DateTime(2026, 7, 14, 11, 17, 47, 380, DateTimeKind.Utc).AddTicks(9268),
                            LayoutId = 2,
                            SnapshotBasePrice = 900000m,
                            SnapshotPriceModifier = 0m,
                            StartTime = new DateTime(2026, 7, 14, 8, 17, 47, 380, DateTimeKind.Utc).AddTicks(9268),
                            UserId = 3
                        });
                });

            modelBuilder.Entity("backend.Entities.BookingLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Entities.InternalTask", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookingId = 2,
                            CreatedAt = new DateTime(2026, 7, 14, 9, 17, 47, 389, DateTimeKind.Utc).AddTicks(302),
                        ...
                        new
                        {
                            Id = 2,
                            BookingId = 3,
                            CreatedAt = new DateTime(2026, 7, 14, 9, 17, 47, 389, DateTimeKind.Utc).AddTicks(635),
                            RequiredStaffCount = 1,
            ...
            modelBuilder.Entity("backend.Entities.SpaceAsset", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 7,
                            AreaM2 = 16.00m,
                            AssetName = "Phòng Nghiên Cứu 204",
                            AssetType = "Meeting_Room",
                            BasePrice = 200000m,
                            Capacity = 8,
                            Dimensions = "4m x 4m",
            ...
            modelBuilder.Entity("backend.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$8cnTwJSdRphKyFiXlNaIYumZuaKhJr.SyjBZbO2B84erHo13lFSVm",
                            Role = "ADMIN"
                        },
                        new
                        {
