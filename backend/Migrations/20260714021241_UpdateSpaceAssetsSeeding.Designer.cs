...
namespace backend.Migrations
{
    ...
    [Migration("20260714021241_UpdateSpaceAssetsSeeding")]
    partial class UpdateSpaceAssetsSeeding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Entities.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 14, 2, 12, 40, 839, DateTimeKind.Utc).AddTicks(895),
                            EndTime = new DateTime(2026, 7, 15, 4, 12, 40, 839, DateTimeKind.Utc).AddTicks(248),
                            LayoutId = 1,
                            PaymentDeadline = new DateTime(2026, 7, 14, 2, 22, 40, 839, DateTimeKind.Utc).AddTicks(714),
                            SnapshotBasePrice = 50000m,
                            SnapshotPriceModifier = 0m,
                            StartTime = new DateTime(2026, 7, 15, 2, 12, 40, 839, DateTimeKind.Utc).AddTicks(64),
                            UserId = 3
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 14, 2, 12, 40, 839, DateTimeKind.Utc).AddTicks(1011),
                            EndTime = new DateTime(2026, 7, 16, 6, 12, 40, 839, DateTimeKind.Utc).AddTicks(1009),
                            LayoutId = 1,
                            SnapshotBasePrice = 1200000m,
                            SnapshotPriceModifier = 50000m,
                            StartTime = new DateTime(2026, 7, 16, 2, 12, 40, 839, DateTimeKind.Utc).AddTicks(1009),
                            UserId = 4
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 14, 2, 12, 40, 839, DateTimeKind.Utc).AddTicks(1014),
                            EndTime = new DateTime(2026, 7, 14, 4, 12, 40, 839, DateTimeKind.Utc).AddTicks(1013),
                            LayoutId = 2,
                            SnapshotBasePrice = 900000m,
                            SnapshotPriceModifier = 0m,
                            StartTime = new DateTime(2026, 7, 14, 1, 12, 40, 839, DateTimeKind.Utc).AddTicks(1013),
                            UserId = 3
                        });
                });
            ...
            modelBuilder.Entity("backend.Entities.InternalTask", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookingId = 2,
                            CreatedAt = new DateTime(2026, 7, 14, 2, 12, 40, 839, DateTimeKind.Utc).AddTicks(2667),
                        ...
                        new
                        {
                            Id = 2,
                            BookingId = 3,
                            CreatedAt = new DateTime(2026, 7, 14, 2, 12, 40, 839, DateTimeKind.Utc).AddTicks(2787),
                            RequiredStaffCount = 1,
            ...
            modelBuilder.Entity("backend.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$snwbZQTfzv0rYpKMDFAtgeX94gjkBz2WicorITqNmcQizjlUE1NwC",
                            Role = "ADMIN"
                        },
                        new
                        {
